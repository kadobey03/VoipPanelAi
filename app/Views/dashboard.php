...
<body class="bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
  <div class="container mx-auto p-4">
    ...
    <div class="mt-6 flex gap-2 flex-wrap">
      ...
      <a href="/agents" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded">Agent Durum</a>
      <a href="/numbers" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded">Dış Numaralar</a>
